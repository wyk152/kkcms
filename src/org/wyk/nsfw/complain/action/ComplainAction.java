package org.wyk.nsfw.complain.action;
...
import org.wyk.nsfw.complain.entity.ComplainReply;
...
public class ComplainAction extends BaseAction {
	...
	public String listUI(){
		...
		try {
			...
			pageResult = complainService.findObjectsList(queryHelper, getPageNo(), getPageSize());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "listUI";
